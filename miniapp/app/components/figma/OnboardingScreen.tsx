...
export function OnboardingScreen({ continueHref = "/lobby" }: OnboardingScreenProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between p-6 py-12 pb-24">
      <div className="flex-1 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-xl font-semibold mb-2">Battle for real $MILLION prizes</p>
            ...
            {[...Array(15)].reverse().map((_, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`h-3 w-32 rounded-full transition-all duration-300 ${
                      isActive
                        ? isMilestone
                  ...
                  />
                  {isMilestone && (
                    <span className={`text-xs font-semibold transition-opacity ${isActive ? "opacity-100" : "opacity-0"}`}>
                      {level === 15 ? "🏆" : "✓"}
                    </span>
                  )}
                </div>
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        <p className="text-xs text-center text-gray-500">
          ...
          <Link href="/terms" className="text-[#0066FF] underline">
            Terms
          </Link>{" "}
          and Privacy Policy
        </p>
